...
@RestController
@RequestMapping("/api/facilities/me/invoices")
...
public class FacilityInvoiceController {
    ...
    public ResponseEntity<PagedResponse<ClientInvoiceResponse>> listMine(
            ...
            Pageable pageable) {
        return ResponseEntity.ok(invoiceService.listForFacilityUser(
    ...
    public ResponseEntity<ClientInvoiceResponse> getMine(
        ...
        return ResponseEntity.ok(invoiceService.getForFacilityUser(
    ...
    public ResponseEntity<byte[]> pdfMine(
        ...
        var report = invoiceService.exportPdfForFacility(
                id, userService.getByEmail(authentication.getName()));
